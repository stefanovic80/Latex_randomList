...
\begin{center}
	{\bf Compito in classe di matematica del \today }
\end{center}


  \begin{randomList}
    \item I proprietari degli appartamenti di un condonominio contribuiscono alle spese di gestione e manutenzione delle parti comuni in proporzione ai millesimi che competono a ciascun. Secondo regole che tengono conto di diversi parametri, a ogni proprietario viene associata una quota in millesimi di ogni spesa condominiale mediante la tabella \ref{tab:millesimi1}.\\
    %\begin{enumerate}
		%\item 
		{\bf a)} Calcola quanto dovrà pagare Lucia Cartesiani se il condominio deciderà di costruire un ascensore del costo complessivo di 120000 euro.\\
		%\item 
		{\bf b} Se il preventivo iniziale è salito del $20\%$ a fine lavori, quanto dovrà pagare in più?    
    %\end{enumerate}

    \item Gli animali sono belli. In figura \ref{fig:piccione1}, abbiamo un fantastico piccione.
...
\end{tabular}
\caption{\label{tab:millesimi1}Your caption.}
\end{center}
\end{table}
...
\end{center}
  ...
  \begin{randomList}
    \item I proprietari degli appartamenti di un condonominio contribuiscono alle spese di gestione e manutenzione delle parti comuni in proporzione ai millesimi che competono a ciascun. Secondo regole che tengono conto di diversi parametri, a ogni proprietario viene associata una quota in millesimi di ogni spesa condominiale mediante la tabella \ref{tab:millesimi2}.\\
    %\begin{enumerate}
		%\item 
		{\bf a)} Calcola quanto dovrà pagare Lucia Cartesiani se il condominio deciderà di costruire un ascensore del costo complessivo di 120000 euro.\\
		%\item 
    ...
    \item Gli animali sono belli. In figura \ref{fig:piccione2}, abbiamo un fantastico piccione.
...
\end{tabular}
\caption{\label{tab:millesimi2}Your caption.}
\end{center}
\end{table}
