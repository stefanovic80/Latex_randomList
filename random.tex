...
\end{center}
  ...
  \begin{randomList}
    \item First item\\
    Questo è un testo scritto in lingua italiana. Si noti che le parole accentate sono scritte secondo la tastiera italiana. Qui abbiamo (tabella \ref{tab:millesimi})

    \item Gli animali sono belli. In figura \ref{fig:piccione}, abbiamo un fantastico piccione.
...
\end{tabular}
\caption{\label{tab:millesimi}Your caption.}
\end{center}
\end{table}
...
Abbiamo anche aggiunto una tabella
